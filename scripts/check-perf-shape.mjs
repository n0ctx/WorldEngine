...
import {
  ...
  isTestPath, loadBaseline, parseArgs, parseFiles, patternNames, scanHealth, section, stringValue, suffixDuplicates,
  walk, writeBaseline,
...
function main() {
  ...
  const healthFailures = scanHealth({ ...shape, emptyMessage: `没有扫到任何文件（${SCAN_DIRS.join('、')}），遍历逻辑可能坏了` });
