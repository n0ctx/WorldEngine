...
import {
  ...
  parseArgs, parseFiles, scanHealth, section, stringValue, suffixDuplicates, walk, writeBaseline,
...
function main() {
  ...
  const healthFailures = scanHealth({ ...shape, emptyMessage: '没有扫到任何测试文件，遍历逻辑可能坏了' });
