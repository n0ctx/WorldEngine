...
- refactor(assistant): 下沉 toLLMTool / wrapToolEvents 到 assistant/server/tools/_adapter.js，父子代理共享；wrapToolEvents 通过 opts 注入 cancelCheck / onCancelLog，callId 改用 crypto.randomUUID
