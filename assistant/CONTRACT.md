...
```json
{ "op": "create", "title": "标题", "summary": "简介", "content": "正文", "keywords": ["a", "b"] }
```

```json
{ "op": "update", "id": "现有条目ID", "title": "标题", "summary": "简介", "content": "正文", "keywords": ["a", "b"] }
```
...
```json
{ "op": "create", "title": "标题", "summary": "简介", "content": "正文", "keywords": ["a"], "mode": "chat" }
```
