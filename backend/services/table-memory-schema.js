...
export const TABLE_SCHEMAS = {
  ...
  world:     { name: '世界状态表', columns: ['规则/事实', '影响范围', '当前状态', '来源事件', '是否可逆'],
    defaultMaxRows: 20,
    purpose: '只记「开局世界观设定之后、因剧情而新发生」的世界级变化与既成事实，是一张「世界变更日志」，不是世界设定的快照。开局设定里本来就有、且没有改变的静态前提（世界规则、门派性质、地理常识等）一律不要登记——那些已在世界书里。只有当某条设定被剧情打破/改写，或出现了原设定没有的新世界级事实时才记，「规则/事实」列写这条变化本身、「来源事件」写它由什么剧情造成。' },
};
