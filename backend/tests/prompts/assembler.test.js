...
test('buildWritingPrompt 在写作模式下合并多角色条目、状态与写作专属开关', async () => {
  ...
  insertCharacterEntry(sandbox.db, alpha.id, { title: '阿尔法条目', content: '条目命中：{{char}}', keywords: ['当前场景'] });
  insertCharacterEntry(sandbox.db, beta.id, { title: '贝塔条目', content: '条目命中：{{char}}', keywords: ['当前场景'] });
